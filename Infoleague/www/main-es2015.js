...
const routes = [
    ...
    Object.assign({ path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | home-home-module */ "home-home-module").then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule) }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["redirectUnauthorizedTo"])(['login']))),
    {
        path: 'list',
        loadChildren: () => __webpack_require__.e(/*! import() | ListaEquipos-list-module */ "ListaEquipos-list-module").then(__webpack_require__.bind(null, /*! ./ListaEquipos/list.module */ "./src/app/ListaEquipos/list.module.ts")).then(m => m.ListPageModule)
    },
    {
        path: 'favoritos',
        loadChildren: () => Promise.all(/*! import() | pages-favoritos-favoritos-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-favoritos-favoritos-module")]).then(__webpack_require__.bind(null, /*! ./pages/favoritos/favoritos.module */ "./src/app/pages/favoritos/favoritos.module.ts")).then(m => m.FavoritosPageModule)
    },
    {
        path: 'create-fav',
    ...
    {
        path: 'modal-page',
        loadChildren: () => __webpack_require__.e(/*! import() | modal-page-modal-page-module */ "modal-page-modal-page-module").then(__webpack_require__.bind(null, /*! ./modal-page/modal-page.module */ "./src/app/modal-page/modal-page.module.ts")).then(m => m.ModalPagePageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'reset-password',
        loadChildren: () => __webpack_require__.e(/*! import() | reset-password-reset-password-module */ "reset-password-reset-password-module").then(__webpack_require__.bind(null, /*! ./reset-password/reset-password.module */ "./src/app/reset-password/reset-password.module.ts")).then(m => m.ResetPasswordPageModule)
    },
    {
        path: 'user',
